...
export default function CharacterOrbit() {
  ...
  useRaf(() => {
    ...
    const Rx = isMobile ? vw * 0.38 : isTablet ? vw * 0.32 : vw * 0.3; // horizontal orbit radius
    const Ry = isMobile ? vh * 0.08 : isTablet ? vh * 0.12 : vh * 0.15; // vertical tilt
    ...
    for (let i = 0; i < N; i++) {
      ...
      const scaleMin = isMobile ? 0.38 : isTablet ? 0.52 : 0.6;
      const scaleMax = isMobile ? 0.72 : isTablet ? 0.92 : 1.06;
      const scale = lerp(scaleMin, scaleMax, depth01) * lerp(0.5, 1, enter);
